...
?>
      <tr>
		...
		<td><div align="center"><img src="images/<?php echo $buff['gambar_product']; ?>" width="200" height="200"></div></td>
 <td width="55"><div align="center"><a href="edit_product.php?kode_barang=<?php echo $buff['kode_barang']; ?>" class="style5"><strong>Edit</strong></a> 
 </div>
 <td width="47"><div align="center"><a href="hapus_product.php?kode_barang=<?php echo $buff['kode_barang']; ?>">Hapus</a> </div> </tr>
      <?php
};
mysql_close($sambung);
?>
