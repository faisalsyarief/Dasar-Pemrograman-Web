...
?>
 ...
 <h2><center>TAMBAH PRODUCT</center></h2>
  <form name="form1" method="post" action="input_product.php" enctype="multipart/form-data">
  <table width="955" align="center">
    <tr>
      <td width="271" height="48" valign="top"><p>&nbsp;</p>
        <table width="170" height="126" align="center">
        <tr>
          <td width="177" height="120"></td>
        </tr>
      </table></td>
      <td width="400" valign="top"><table width="400" align="center">
        <tr>
          <td><strong>Kode Barang</strong></font></td>
          <td><input name="kode_barang" type="text" size="35"></td>
        </tr>
        <tr>
          <td><strong>Jenis Barang</strong></font></td>
          <td><input name="jenis_barang" type="text" size="35"></td>
        </tr>
        <tr>
          <td><strong>Harga Barang</strong></font></td>
          <td><input name="harga_barang" type="text" size="35"></td>
        </tr>
		  <tr>
          <td><strong>Upload Gambar</strong></font></td>
  ...
  <td><input type="submit" name="submit" value="Simpan">
      ...
      <input value="Kembali" type="button"  onClick="self.history.back()"></td>
  </tr>
      </table></td>
