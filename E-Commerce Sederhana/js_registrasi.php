...
<form action="js_info_reg.php" method="post">
<tr bgcolor="gray">
<td bgcolor="#4682B4" width="140"><font color="white" >Nama Lengkap</font></td>
<td bgcolor="#9FAFDF" width="340"><input type="text" name="nama_lengkap" size="30"></td>
</tr>

<tr>
<td bgcolor="#4682B4" width="140"><font color="white" >Telpon</font></td>
<td bgcolor="#9FAFDF" width="340"><input type="text" name="telepon" size="30"></td>
</tr>	

<tr>
<td bgcolor="#4682B4" width="140"><font color="white" >Product Yang Di Beli</font></td>
<td bgcolor="#9FAFDF" width="340"><input type="text" name="product" size="30"></td>
</tr>

<tr>
<td bgcolor="#4682B4" width="140"><font color="white">Alamat</font></td>
<td bgcolor="#9FAFDF" width="340"><input type="text" name="alamat" size="30"></td>
</tr>

<tr>
<td bgcolor="#4682B4" width="140"><font color="white">Tanggal Pembelian</font></td>
<td bgcolor="#9FAFDF" width="340"><input type="date" name="tanggal" size="30"></td>
</tr>
						
<tr>
<td bgcolor="#4682B4" width="140"></td>
<td bgcolor="#9FAFDF" width="340"><input type="submit" name="send" value="Send">
